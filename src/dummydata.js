import sliderimg1 from '../src/assets/sliderimage1.webp'
import sliderimg2 from '../src/assets/silderimg2.jpg';
import sliderimg3 from '../src/assets/sliderimg3.jpg';
import kurta from '../src/assets/kurta.jpg';
import coords from '../src/assets/coords.jpg';
import western from '../src/assets/western.jpg';
import bestseller from '../src/assets/bestsell.jpg';
import all from '../src/assets/all.jpg';
export const sliderItems = [
  {
    id: 1,
    image: sliderimg2,
    title: "",
    desc: "Stay Cool, Look Hot – Embrace Summer in Style!",
    bg: "#f5fafd", // Added # for valid hex color
  },
  {
    id: 2,
    image: sliderimg1,
    title: "",
    desc: "Timeless Trends, Perfectly Curated for You!",
    bg: "#fcf1ed", // Added #
  },
  {
    id: 3,
    image: sliderimg3,
    title: "",
    desc: "Step Out in Style with Dresses That Define You!",
    bg: "#fbf0f4", // Added #
  },
